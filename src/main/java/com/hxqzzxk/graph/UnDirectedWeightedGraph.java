...
public class UnDirectedWeightedGraph implements IUnDirectedWeightedGraph {
    /**
     * 顶点数量
     */
     ...
     * @param pairs    边列表
     */
    public UnDirectedWeightedGraph(int vertexes, int edges, int[][] pairs) {
     ...
     * @param pairs 边列表
     */
    public UnDirectedWeightedGraph(int[][] pairs) {
        int vertexes = 0;
